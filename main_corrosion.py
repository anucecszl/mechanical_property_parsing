...
mech_data = pandas.read_excel('HEA_Corrosion_dataset_ZL.xlsx')
element_set = set()
...
if __name__ == '__main__':
    ...
    output_df = pandas.concat([phases_df, mech_data.drop([feature[1], feature[7], feature[8]], axis=1), ratios_df],
                              axis=1)
    print(output_df)
    output_df.to_excel('parsed_result_corrosion.xlsx')
